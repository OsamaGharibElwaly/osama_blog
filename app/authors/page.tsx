          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div key={author.id} className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
                  <div className="flex items-center gap-8">
                    ...
                    <div>
                      ...
                      <Link href={`/authors/${author.id}`} className="mt-6 inline-block text-blue-600 hover:underline">
                        View Profile →
                      </Link>
                    </div>
                  </div>
            ...
            <aside className="space-y-8">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg text-center">
                ...
                <Link href="/contact" className="mt-4 inline-block text-blue-600 hover:underline">
                  Contact Us →
                </Link>
              </div>
            </aside>
